  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        gradient: "border-transparent bg-gradient-primary text-primary-foreground hover:shadow-glow-primary hover:scale-105",
        accent: "border-transparent bg-accent text-accent-foreground hover:bg-accent/80 hover:scale-105",
      },
    },
    defaultVariants: {
      variant: "default",
